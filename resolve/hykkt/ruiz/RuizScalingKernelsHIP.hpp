...
namespace ReSolve
{
  namespace hykkt
  {
    ...
    class RuizScalingKernelsHIP : public RuizScalingKernelImpl
    {
    public:
      void adaptRowMax(index_type n_hes, index_type n_total, index_type* hes_i, index_type* hes_j, real_type* hes_v, index_type* jac_i, index_type* hes_tr_j, real_type* jac_v, index_type* jac_tr_i, index_type* jac_tr_j, real_type* jac_tr_v, real_type* scaling_vector);
