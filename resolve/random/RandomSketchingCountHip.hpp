/**
 * @file RandomSketchingCountHip.hpp
 * @author Kasia Swirydowicz (kasia.swirydowicz@pnnl.gov)
 * @author Slaven Peles (peless@ornl.gov)
 * @brief Declaration of RandomSketchingCountHip class.
 * 
 */
#pragma once
...
namespace ReSolve {
  ...
  /**
   * @brief Count sketch implementation for a HIP device.
   * 
   */
  class RandomSketchingCountHip : public RandomSketchingImpl
  {
    private:
      using vector_type = vector::Vector;
    public: 
      // constructor
      RandomSketchingCountHip();
      // destructor
      virtual ~RandomSketchingCountHip();
