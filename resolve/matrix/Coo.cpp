...
namespace ReSolve
{
  ...
  matrix::Coo::Coo(index_type n, index_type m, index_type nnz)
    : Sparse(n, m, nnz)
  {
  }
                              ...
                              memory::MemorySpace memspaceOut)
  {
    ...
    if (memspaceOut == memory::HOST) {
      ...
      if ((h_row_data_ == nullptr) != (h_col_data_ == nullptr)) {
        out::error()
            << "In Coo::updateData one of host row or column data is null!\n";
      }
      if ((h_row_data_ == nullptr) && (h_col_data_ == nullptr)) {
    ...
    if (memspaceOut == memory::DEVICE) {
      ...
      if ((d_row_data_ == nullptr) != (d_col_data_ == nullptr)) {
        out::error()
            << "In Coo::updateData one of device row or column data is null!\n";
      }
      if ((d_row_data_ == nullptr) && (d_col_data_ == nullptr)) {
    ...
    switch (memspaceOut) {
      case HOST:
        if ((d_data_updated_ == true) && (h_data_updated_ == false)) {
          if ((h_row_data_ == nullptr) != (h_col_data_ == nullptr)) {
            out::error()
                << "In Coo::copyData one of host row or column data is null!\n";
          }
          if ((h_row_data_ == nullptr) && (h_col_data_ == nullptr)) {
      ...
      case DEVICE:
        if ((d_data_updated_ == false) && (h_data_updated_ == true)) {
          if ((d_row_data_ == nullptr) != (d_col_data_ == nullptr)) {
            out::error() << "In Coo::copyData one of device row or column data "
                            "is null!\n";
          }
          if ((d_row_data_ == nullptr) && (d_col_data_ == nullptr)) {
            mem_.allocateArrayOnDevice(&d_row_data_, nnz_current);
  ...
  void matrix::Coo::print(std::ostream& out)
  {
    ...
    for (int i = 0; i < nnz_; ++i) {
      out << h_row_data_[i] << " " << h_col_data_[i] << " " << h_val_data_[i]
          << "\n";
    }
  }
