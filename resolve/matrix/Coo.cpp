...
namespace ReSolve
{
  ...
  int matrix::Coo::syncData(memory::MemorySpace memspace)
  {
    ...
    {
    case HOST:
      assert(((h_row_data_ == nullptr) == (h_col_data_ == nullptr)) && "In Coo::syncData one of host row or column data is null!\n");
      ...
      return 0;
    case DEVICE:
      assert(((d_row_data_ == nullptr) == (d_col_data_ == nullptr)) && "In Coo::syncData one of device row or column data is null!\n");
