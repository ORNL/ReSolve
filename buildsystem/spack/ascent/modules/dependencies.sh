module use -a /gpfs/wolf/proj-shared/csc359/resolve/github-ci/install/modules/linux-rhel8-power9le
# cmake@=3.22.2%gcc@=10.2~doc+ncurses+ownlibs build_system=generic build_type=Release arch=linux-rhel8-power9le
module load cmake/3.22.2-gcc-10.2-jukgoau
...
# resolve@=develop%gcc@=10.2+cuda~ipo+klu build_system=cmake build_type=Release cuda_arch=70 dev_path=/gpfs/wolf/proj-shared/csc359/ci/469618 generator=make arch=linux-rhel8-power9le
## module load resolve/develop-gcc-10.2-bg35urs
