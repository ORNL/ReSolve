...
/*
broken (maybe theres limits to how low the error can get)
    "thermomech_dM",
    "oilpan",
    "bundle_adj",
    "Geo_1438",
    ...
    queen, lfat5000, bloweybq, uni_chimerai2, trefethen_20

    GENUINELY BROKEN, DONT EVEN TRY: LFAT5, LF10, nos4
*/
