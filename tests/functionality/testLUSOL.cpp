...
int main(int argc, char* argv[])
{
  ...
  std::string matrix_one_path = data_path + "/data/matrix_ACTIVSg200_AC_renumbered_add9_01.mtx";
  std::string matrix_two_path = data_path + "/data/matrix_ACTIVSg200_AC_renumbered_add9_02.mtx";

  std::string rhs_one_path = data_path + "/data/rhs_ACTIVSg200_AC_renumbered_add9_ones_01.mtx";
  std::string rhs_two_path = data_path + "/data/rhs_ACTIVSg200_AC_renumbered_add9_ones_02.mtx";
